...
public class WithoutSelectingDeleteContactTest extends BaseClass {
	@Test
	public void deleteContactWithActionAndClickOnCancelTest() {
		...
		hp.getContactEdt().click();
		/* Click on Delete Button Without Selecting on cantact Check Box*/
		ct.getwithoutSelectingDeleteContactbtn().click();
		/* Click on Pop up*/
